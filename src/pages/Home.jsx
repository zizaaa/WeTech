  ...
  return (
    <section className="">
        ...
        <div className='container mx-auto flex items-center w-full h-[80vh] md:px-0 px-10'>
            ...
            <div className="img-container flex-1 h-full lg:flex items-center  hidden" >
        ...
        <div className='container mx-auto flex flex-col items-center mt-7 md:px-0 px-10'>
            ...
            <div className='mt-10 flex flex-col lg:flex-row items-center gap-20 mb-10'>
                ...
                <div className='project-1 flex items-center justify-between gap-10 lg:flex-row flex-col-reverse rounded-xl border-b-4 border-white hover:border-orange p-3 relative'>
                ...
                <div className='project-1 flex items-center justify-between gap-10 lg:flex-row flex-col rounded-xl border-b-4 border-white hover:border-orange p-3 relative'>
                    <Link className='absolute top-0 right-0 text-gray text-xl hover:text-black transition-all ease-in-out duration-300'>
                        <FaExternalLinkAlt/>
                    </Link>
                    <div className='flex-1'>
